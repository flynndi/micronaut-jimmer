...
public class RedisCacheCreator extends AbstractCacheCreator {
    ...
    public RedisCacheCreator(RedisClient redisClient) {
        this(redisClient, null);
    }

    public RedisCacheCreator(RedisClient redisClient, ObjectMapper objectMapper) {
        super(new Root(redisClient, objectMapper));
    }
    ...
    private static class Root extends Cfg {
        ...
        private Root(RedisClient redisClient, ObjectMapper objectMapper) {
            super(null);
    ...
    static class Args extends AbstractCacheCreator.Args {
        ...
        Args(Cfg cfg) {
            ...
            this.redisClient = root.redisClient;
            ObjectMapper mapper = root.objectMapper;
            ObjectMapper clonedMapper =
                    mapper != null ? new ObjectMapper(mapper) {} : new ObjectMapper();
