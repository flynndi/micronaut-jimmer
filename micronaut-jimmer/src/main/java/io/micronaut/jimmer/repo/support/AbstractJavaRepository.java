...
import io.micronaut.jimmer.repo.JavaRepository;
...
public class AbstractJavaRepository<E, ID> implements JavaRepository<E, ID> {
    ...
    public AbstractJavaRepository(JSqlClient sql) {
        ...
        Class<?>[] typeArguments =
                GenericTypeUtils.resolveSuperTypeGenericArguments(
                        this.getClass(), AbstractJavaRepository.class);
    ...
    @NotNull
    @Override
    public <V extends View<E>> List<V> findAll(
            Class<V> viewType, TypedProp.Scalar<?, ?>... sortedProps) {
        DtoMetadata<E, V> metadata = DtoMetadata.of(viewType);
        ConfigurableRootQuery<?, V> query =
                createQuery(metadata.getFetcher(), metadata.getConverter(), sortedProps);
        return query.execute();
    }
    ...
    @NotNull
    @Override
    public <V extends View<E>> Page<V> findPage(
    ...
    @NotNull
    @Override
    public <V extends View<E>> Slice<V> findSlice(
    ...
    @NotNull
    @Override
    public BatchEntitySaveCommand<E> saveInputsCommand(
