...
interface KotlinRepository<E : Any, ID : Any> {
    ...
    fun <V : View<E>> findById(
        id: ID,
        viewType: KClass<V>,
    ): V?

    fun findByIds(ids: Iterable<ID>): List<E> = findByIds(ids, null as Fetcher<E>?)
    ...
    fun <V : View<E>> findByIds(
        ids: Iterable<ID>,
        viewType: KClass<V>,
    ): List<V>

    fun findMapByIds(ids: Iterable<ID>): Map<ID, E> = findMapByIds(ids, null as Fetcher<E>?)
    ...
    fun <V : View<E>> findMapByIds(
        ids: Iterable<ID>,
        viewType: KClass<V>,
    ): Map<ID, V>

    fun findAll(block: (SortDsl<E>.() -> Unit)? = null): List<E> = findAll(null as Fetcher<E>?, block)
    ...
    fun findPage(
        pageParam: PageParam,
        block: (SortDsl<E>.() -> Unit)? = null,
    ): Page<E> = findPage(pageParam, null as Fetcher<E>?, block)
    ...
    fun findSlice(
        ...
        offset: Int,
        block: (SortDsl<E>.() -> Unit)? = null,
    ): Slice<E> = findSlice(limit, offset, null as Fetcher<E>?, block)
    ...
    @Deprecated(
        ...
        replaceWith =
            ReplaceWith(
                "saveEntitiesCommand(entities, mode, associatedMode).execute(fetcher)",
            ),
    )
    fun saveEntities(
        entities: Iterable<E>,
    ...
    @Deprecated(
        ...
        replaceWith =
            ReplaceWith(
                "saveInputsCommand(inputs, mode, associatedMode).execute(fetcher)",
            ),
    )
    fun saveInputs(
        inputs: Iterable<Input<E>>,
    ...
    @Deprecated(
        ...
        replaceWith =
            ReplaceWith(
                "saveEntitiesCommand(entities, mode, associatedMode).execute(viewType)",
            ),
    )
    fun <V : View<E>> saveEntities(
        entities: Iterable<E>,
    ...
    @Deprecated(
        ...
        replaceWith =
            ReplaceWith(
                "saveInputsCommand(inputs, mode, associatedMode).execute(viewType)",
            ),
    )
    fun <V : View<E>> saveInputs(
        inputs: Iterable<Input<E>>,
    ...
    fun insert(
        ...
        associatedMode: AssociatedSaveMode = AssociatedSaveMode.APPEND,
        block: (KSaveCommandPartialDsl.() -> Unit)? = null,
    ): KSimpleSaveResult<E> = insert(input.toEntity(), associatedMode, block)
    ...
    fun insertIfAbsent(
        ...
        associatedMode: AssociatedSaveMode = AssociatedSaveMode.APPEND_IF_ABSENT,
        block: (KSaveCommandPartialDsl.() -> Unit)? = null,
    ): KSimpleSaveResult<E> = insertIfAbsent(input.toEntity(), associatedMode, block)
    ...
    fun update(
        ...
        associatedMode: AssociatedSaveMode = AssociatedSaveMode.UPDATE,
        block: (KSaveCommandPartialDsl.() -> Unit)? = null,
    ): KSimpleSaveResult<E> = update(input.toEntity(), associatedMode, block)
    ...
    fun merge(
        ...
        associatedMode: AssociatedSaveMode = AssociatedSaveMode.MERGE,
        block: (KSaveCommandPartialDsl.() -> Unit)? = null,
    ): KSimpleSaveResult<E> = merge(input.toEntity(), associatedMode, block)
