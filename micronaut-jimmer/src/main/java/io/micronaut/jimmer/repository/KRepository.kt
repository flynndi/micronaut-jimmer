...
interface KRepository<E : Any, ID : Any> : PageableRepository<E, ID> {
    val sql: KSqlClient
    ...
    override fun findById(id: ID): Optional<E> = Optional.ofNullable(findNullable(id))

    fun findById(
        id: ID,
        fetcher: Fetcher<E>,
    ): Optional<E> = Optional.ofNullable(findNullable(id, fetcher))
    ...
    fun findAllById(ids: Iterable<ID>): List<E> = findByIds(ids)
    ...
    override fun findAll(): List<E> = findAll(null)
    ...
    override fun findAll(sort: Sort): List<E> = findAll(null, sort)
    ...
    override fun existsById(id: ID): Boolean = findNullable(id) != null
    ...
    fun saveCommand(
        input: Input<E>,
        block: (KSaveCommandDsl.() -> Unit)? = null,
    ): KSimpleEntitySaveCommand<E> = saveCommand(input.toEntity(), block)
    ...
    fun saveInputsCommand(
        ...
        block: (KSaveCommandDsl.() -> Unit)? = null,
    ): KBatchEntitySaveCommand<E> = saveEntitiesCommand(input.map { it.toEntity() }, block)
    ...
    @Suppress("UNCHECKED_CAST")
    override fun <S : E> saveAll(entity: Iterable<S>): List<S> =
    ...
    fun insert(
        ...
        block: (KSaveCommandPartialDsl.() -> Unit)? = null,
    ): E = save(input, SaveMode.INSERT_ONLY, associatedMode, block)
    ...
    fun insert(
        ...
        associatedMode: AssociatedSaveMode = AssociatedSaveMode.APPEND,
        block: (KSaveCommandPartialDsl.() -> Unit)? = null,
    ): E = save(entity, SaveMode.INSERT_ONLY, associatedMode, block)
    ...
    fun insertIfAbsent(
        ...
        block: (KSaveCommandPartialDsl.() -> Unit)? = null,
    ): E = save(input, SaveMode.INSERT_IF_ABSENT, associatedMode, block)
    ...
    fun insertIfAbsent(
        ...
        associatedMode: AssociatedSaveMode = AssociatedSaveMode.APPEND_IF_ABSENT,
        block: (KSaveCommandPartialDsl.() -> Unit)? = null,
    ): E = save(entity, SaveMode.INSERT_IF_ABSENT, associatedMode, block)

    override fun <S : E> update(entity: S): S = save(entity)

    override fun <S : E> updateAll(entities: Iterable<S>): List<S> = saveAll(entities)
    ...
    fun update(
        ...
        block: (KSaveCommandPartialDsl.() -> Unit)? = null,
    ): E = save(input, SaveMode.UPDATE_ONLY, associatedMode, block)
    ...
    fun update(
        ...
        associatedMode: AssociatedSaveMode = AssociatedSaveMode.UPDATE,
        block: (KSaveCommandPartialDsl.() -> Unit)? = null,
    ): E = save(entity, SaveMode.UPDATE_ONLY, associatedMode, block)
    ...
    fun merge(
        input: Input<E>,
        block: (KSaveCommandPartialDsl.() -> Unit)? = null,
    ): E = save(input, SaveMode.UPSERT, AssociatedSaveMode.MERGE, block)
    ...
    fun merge(
        entity: E,
        block: (KSaveCommandPartialDsl.() -> Unit)? = null,
    ): E = save(entity, SaveMode.UPSERT, AssociatedSaveMode.MERGE, block)
