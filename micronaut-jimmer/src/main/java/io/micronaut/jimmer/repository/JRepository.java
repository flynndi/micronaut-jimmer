...
public interface JRepository<E, ID> extends PageableRepository<E, ID> {
    ...
    Page<E> findAll(
            int pageIndex, int pageSize, Fetcher<E> fetcher, TypedProp.Scalar<?, ?>... sortedProps);
    ...
    @NotNull
    default BatchEntitySaveCommand<E> saveInputsCommand(
    ...
    default <S extends E> S save(@NotNull S entity) {
        return (S) saveCommand(entity).execute().getModifiedEntity();
    }

    @SuppressWarnings("unchecked")
    @NotNull
    default <S extends E> List<S> saveAll(@NotNull Iterable<S> entities) {
        return (List<S>)
                saveEntitiesCommand((List<E>) entities).execute().getItems().stream()
                        .map(BatchSaveResult.Item::getModifiedEntity)
                        .collect(Collectors.toList());
    }

    default E save(E entity, SaveMode mode) {
        return saveCommand(entity).setMode(mode).execute().getModifiedEntity();
    }

    default E save(E entity, SaveMode mode, AssociatedSaveMode associatedMode) {
    ...
    default List<E> saveEntities(Iterable<E> entities) {
        return saveEntitiesCommand(entities).execute().getItems().stream()
                .map(BatchSaveResult.Item::getModifiedEntity)
                .collect(Collectors.toList());
    }

    default List<E> saveEntities(Iterable<E> entities, SaveMode mode) {
        return saveEntitiesCommand(entities).setMode(mode).execute().getItems().stream()
                .map(BatchSaveResult.Item::getModifiedEntity)
                .collect(Collectors.toList());
    }
    ...
    default E save(Input<E> input) {
        return saveCommand(input).execute().getModifiedEntity();
    }

    default E save(Input<E> input, SaveMode mode, AssociatedSaveMode associatedMode) {
    ...
    default List<E> saveInputs(Iterable<? extends Input<E>> inputs) {
        return saveInputsCommand(inputs).execute().getItems().stream()
                .map(BatchSaveResult.Item::getModifiedEntity)
                .collect(Collectors.toList());
    }
    ...
    /**
     * @deprecated saving and re-fetching by fetcher/viewType is advanced feature, please use
     *     `saveCommand`
     */
    @Deprecated
    default E save(E entity, Fetcher<E> fetcher) {
        return saveCommand(entity).execute(fetcher).getModifiedEntity();
    }
     ...
     */
    @Deprecated
    default E save(E entity, SaveMode mode, AssociatedSaveMode associatedMode, Fetcher<E> fetcher) {
        return saveCommand(entity)
                .setMode(mode)
                .setAssociatedModeAll(associatedMode)
                .execute(fetcher)
     ...
     */
    @Deprecated
    default List<E> saveEntities(Iterable<E> entities, Fetcher<E> fetcher) {
        return saveEntitiesCommand(entities).execute(fetcher).getItems().stream()
                .map(BatchSaveResult.Item::getModifiedEntity)
                .collect(Collectors.toList());
    }
     ...
     */
    @Deprecated
    default E save(Input<E> input, Fetcher<E> fetcher) {
        return saveCommand(input).execute(fetcher).getModifiedEntity();
    }
     ...
     */
    @Deprecated
    default List<E> saveInputs(Iterable<? extends Input<E>> inputs, Fetcher<E> fetcher) {
        return saveInputsCommand(inputs).execute(fetcher).getItems().stream()
                .map(BatchSaveResult.Item::getModifiedEntity)
                .collect(Collectors.toList());
    }
     ...
     */
    @Deprecated
    default <V extends View<E>> V save(E entity, Class<V> viewType) {
        return saveCommand(entity).execute(viewType).getModifiedView();
    }
     ...
     */
    @Deprecated
    default <V extends View<E>> List<V> saveEntities(Iterable<E> entities, Class<V> viewType) {
        return saveEntitiesCommand(entities).execute(viewType).getViewItems().stream()
     ...
     */
    @Deprecated
    default <V extends View<E>> V save(Input<E> input, Class<V> viewType) {
        return saveCommand(input).execute(viewType).getModifiedView();
    }
    ...
    default <V extends View<E>> List<V> saveInputs(
        ...
        return saveInputsCommand(inputs).execute(viewType).getViewItems().stream()
                .map(BatchSaveResult.View.ViewItem::getModifiedView)
                .collect(Collectors.toList());
    }
    ...
    @Deprecated
    default E save(E entity, AssociatedSaveMode associatedMode) {
        return saveCommand(entity)
                .setAssociatedModeAll(associatedMode)
                .execute()
                .getModifiedEntity();
    ...
    @Deprecated
    default List<E> saveEntities(Iterable<E> entities, AssociatedSaveMode associatedMode) {
        return saveEntitiesCommand(entities)
                .setAssociatedModeAll(associatedMode)
                .execute()
                .getItems()
    ...
    @Deprecated
    default E save(Input<E> input, AssociatedSaveMode associatedMode) {
        return saveCommand(input)
                .setAssociatedModeAll(associatedMode)
                .execute()
                .getModifiedEntity();
    ...
    default E save(Input<E> input, SaveMode mode) {
        return saveCommand(input).setMode(mode).execute().getModifiedEntity();
    }
    ...
    default List<E> saveInputs(Iterable<? extends Input<E>> inputs, SaveMode mode) {
        return saveInputsCommand(inputs).setMode(mode).execute().getItems().stream()
                .map(BatchSaveResult.Item::getModifiedEntity)
                .collect(Collectors.toList());
    }
     ...
     */
    @Deprecated
    default E save(E entity, AssociatedSaveMode associatedMode, Fetcher<E> fetcher) {
        return saveCommand(entity)
                .setAssociatedModeAll(associatedMode)
                .execute(fetcher)
                .getModifiedEntity();
     ...
     */
    @Deprecated
    default E save(E entity, SaveMode mode, Fetcher<E> fetcher) {
        return saveCommand(entity).setMode(mode).execute(fetcher).getModifiedEntity();
    }
     ...
     */
    @Deprecated
    default List<E> saveEntities(Iterable<E> entities, SaveMode mode, Fetcher<E> fetcher) {
        return saveEntitiesCommand(entities).setMode(mode).execute(fetcher).getItems().stream()
                .map(BatchSaveResult.Item::getModifiedEntity)
                .collect(Collectors.toList());
    }
     ...
     */
    @Deprecated
    default E save(Input<E> input, AssociatedSaveMode associatedMode, Fetcher<E> fetcher) {
        return saveCommand(input)
                .setAssociatedModeAll(associatedMode)
                .execute(fetcher)
                .getModifiedEntity();
     ...
     */
    @Deprecated
    default E save(Input<E> input, SaveMode mode, Fetcher<E> fetcher) {
        return saveCommand(input).setMode(mode).execute(fetcher).getModifiedEntity();
    }
    ...
    default List<E> saveInputs(
        ...
        return saveInputsCommand(inputs).setMode(mode).execute(fetcher).getItems().stream()
                .map(BatchSaveResult.Item::getModifiedEntity)
                .collect(Collectors.toList());
    }
     ...
     */
    @Deprecated
    default <V extends View<E>> V save(E entity, SaveMode mode, Class<V> viewType) {
        return saveCommand(entity).setMode(mode).execute(viewType).getModifiedView();
    }
    ...
    default <V extends View<E>> List<V> saveEntities(
        ...
        return saveEntitiesCommand(entities).setMode(mode).execute(viewType).getViewItems().stream()
                .map(BatchSaveResult.View.ViewItem::getModifiedView)
                .collect(Collectors.toList());
    }
     ...
     */
    @Deprecated
    default <V extends View<E>> V save(Input<E> input, SaveMode mode, Class<V> viewType) {
        return saveCommand(input).setMode(mode).execute(viewType).getModifiedView();
    }
    ...
    default <V extends View<E>> List<V> saveInputs(
        ...
        return saveInputsCommand(inputs).setMode(mode).execute(viewType).getViewItems().stream()
                .map(BatchSaveResult.View.ViewItem::getModifiedView)
                .collect(Collectors.toList());
    }
    ...
    default E insertIfAbsent(@NotNull Input<E> input) {
        return save(
                input.toEntity(), SaveMode.INSERT_IF_ABSENT, AssociatedSaveMode.APPEND_IF_ABSENT);
    }
    ...
    @Override
    default <S extends E> @NonNull S update(@NonNull S entity) {
        return save(entity);
    }

    @Override
    default @NonNull <S extends E> List<S> updateAll(@NonNull Iterable<S> entities) {
